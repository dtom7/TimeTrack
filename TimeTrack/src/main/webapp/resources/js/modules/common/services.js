	...
	.factory(
		...
		[
			...
			function($modal) {
				...
				var customModal = { open : function(intitle, inmessage) {
					...
					var modalInstance = $modal
						.open({
							...
							controller : 'CustomModalInstanceCtrl', size : 'sm', resolve : { title : function() {
								return intitle;
							}, message : function() {
								return inmessage;
							} } });
	...
	.factory(
		...
		[
			...
			function($modal) {
				...
				var unsavedModal = { open : function(inToState) {
					console.log('In service-open');
					var modalInstance = $modal
						.open({
							...
							controller : 'UnsavedModalInstanceCtrl', size : 'sm', resolve : { toState : function() {
								return inToState;
							} } });
				} };
